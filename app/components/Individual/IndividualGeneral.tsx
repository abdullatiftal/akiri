...
export const IndividualGeneral: FC<IndividualGeneralProps> = ({ title }) => {
    const { onHandleNext, formData, setFormData } = useFormState()

    const { control, register, handleSubmit } =
        useForm<IndividualGeneralFormValues>({ defaultValues: formData })

    const onHandleFormSubmit = (data: IndividualGeneralFormValues) => {
